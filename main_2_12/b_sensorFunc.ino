...
void rotate_()
{
  ...
  motorRotate(1, 16 * rotationAngle); //away from limitswitch
  motorRotate(0, 16 * (rotationAngle + 3)); //towards the limitswitch
...
long takeFirstReading(int chID) {
  ...
  //  if (first1 < 4000 || first2 < 4000) {
  //    Serial.println("Invalid sample.");
  //    sendText(nameArray[chID], "Invalid sample!", 16);
  //    beep(500);
  //    return -2147483648;
  //  }
  ...
  //  float checkDiff = abs( 100.0 - (100.0 * ((float)whiteIntensity[i] / first1)) ); //already White
  //
  //  if (checkDiff < 10.0) {
  //    Serial.println("Channel not started: Less Dye.");
  //    sendText(nameArray[chID], "Less Dye!", 16);
  //    beep(500);
  //    return -2147483648;
  //  }
  //------------------------ All checks end above this ------------------------------
